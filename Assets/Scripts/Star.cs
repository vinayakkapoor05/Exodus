...
public class Star : MonoBehaviour
{
    ...
    [SerializeField] private float energyRechargeRate = 20f;
    ...
    private void Start()
{
    ...
    playerHealth = rocket.GetComponent<PlayerHealth>();
    ...
    private void Update()
    {
        ...
        if (distanceToRocket < damageRadius)
        {
            playerHealth.TakeDamage(damageRate * Time.deltaTime);
            rocket.RechargeEnergy(energyRechargeRate * Time.deltaTime);
        }
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            gameManager.HandleCelestialCollision("Star");
